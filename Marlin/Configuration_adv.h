...
#define FILAMENT_CHANGE_UNLOAD_LENGTH 100         // WAS 550 (mm) The length of filament for a complete unload. 
...
#define FILAMENT_CHANGE_FAST_LOAD_LENGTH 100      // WAS 350 (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.       
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  8 // WAS 75
